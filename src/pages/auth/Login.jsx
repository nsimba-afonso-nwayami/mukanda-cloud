    ...
    <>
      ...
      <section className="relative bg-slate-950 min-h-screen flex items-center justify-center px-6 overflow-hidden">
        ...
        <div className="w-full max-w-sm relative z-10">
          ...
          {/* Card Compacto - Glassmorphism com Bordas Sóbrias */}
          <div className="bg-slate-900/40 backdrop-blur-xl border border-white/5 rounded-lg p-8 shadow-2xl">
            ...
            <form className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-end">
                  <Link to="/recuperar-senha" className="text-[10px] text-slate-500 hover:text-cyan-500 uppercase font-bold tracking-widest transition-colors">
                    Esqueceu a senha?
                  </Link>
                </div>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-white/5 text-center">
              <Link to="/criar-conta" className="text-[10px] text-slate-400 hover:text-white uppercase font-bold tracking-[0.2em] transition-colors">
                Criar Nova Conta
              </Link>
            </div>
          </div>
