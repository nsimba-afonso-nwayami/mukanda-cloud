...
export default function ArquivosSuperAdmin() {
  ...
  /**
   * Handler de Upload com Validação do fileSchema (Yup manual)
   */
  const handleUpload = async (files) => {
    ...
    for (const file of Array.from(files)) {
      ...
      try {
        // Validação manual contra o schema de arquivos (tamanho e tipo)
        ...
        // Captura erro de validação do Yup ou erro do servidor
