...
export default function SidebarGerente({ sidebarOpen, setSidebarOpen }) {
      ...
      >
        ...
        <div className="flex-1">
          ...
          <nav className="space-y-2 text-sm">
            ...
            <Link to="/dashboard/gerente" className={linkStyle}>
              <i className="fas fa-gauge-high text-blue-700"></i>
              Dashboard
            </Link>

            <Link to="/dashboard/gerente/arquivos" className={linkStyle}>
              <i className="fas fa-folder text-blue-700"></i>
              Arquivos
            </Link>

            <Link to="/dashboard/gerente/equipa" className={linkStyle}>
              <i className="fas fa-users text-blue-700"></i>
              Equipa
            </Link>

            <Link to="/dashboard/gerente/permissoes" className={linkStyle}>
              <i className="fas fa-shield-alt text-blue-700"></i>
              Permissões
            </Link>

            <Link to="/dashboard/gerente/atividades" className={linkStyle}>
              <i className="fas fa-clock-rotate-left text-blue-700"></i>
              Atividades
            </Link>

            <Link to="/dashboard/gerente/configuracoes" className={linkStyle}>
